					...
					<form name="promocode_edit" id="promocode_edit" method="post" action="javascript:void(0)" enctype="multipart/form-data">
					    ...
					    <div class="row">
							...
							<div class="mb-3 col-md-6">
								...
								<input type="hidden" name="id" value="<?php echo e($promocodes->id); ?>"/>
								<select id="category_id" name="business_category_id" required class="form-control">
									...
									<?php if(!empty($categorylist)): ?>
										<?php $__currentLoopData = $categorylist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $catlist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<?php if($promocodes->business_category_id == $catlist->id): ?>
											<option selected value="<?php echo e($catlist->id); ?>"><?php echo e($catlist->name); ?></option>
											<?php else: ?>
										<option value="<?php echo e($catlist->id); ?>"><?php echo e($catlist->name); ?></option>
											<?php endif; ?>
							...
							<div class="mb-3 col-md-6">
								...
								<input type="text" id="name" name="name" value="<?php echo e($promocodes->name); ?>" required class="form-control">
							</div>
							<div class="mb-3 col-md-6">
								<label for="Email" class="control-label">Promo Amount: <span style="color:red">*</span></label>
								<input type="text" required id="amount" value="<?php echo e($promocodes->amount); ?>" required name="amount" class="form-control">
							</div>
								...
								<select name="promotion_type" required class="form-control">
									...
									<?php if($promocodes->promotion_type==1): ?>
							...
							<input type="hidden" name="type" value="edit">
								...
								<input type="date" required id="start_valid_date" value="<?php echo e($promocodes->start_valid_date); ?>" required name="start_valid_date" class="form-control activationdate">
							</div>
									<div class="mb-3 col-md-6">
								<label for="date" class="control-label">End Valid Date: <span style="color:red">*</span></label>
								<input type="date" required id="end_valid_date" value="<?php echo e($promocodes->end_valid_date); ?>" required name="end_valid_date" class="form-control activationdate">
							</div>
							
						</div>
						<a type="button" href="<?php echo e(url('/promocode_list')); ?>"class="btn btn-dark fa-pull-left mt-3">Back</a>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\development\wemarkthespot\resources\views/Pages/edit_promocode.blade.php ENDPATH**/ ?>