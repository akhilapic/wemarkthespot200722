            ...
            <div class="row gy-4">
               <?php if($offers): ?>  
                  ...
                  <div class="BoxShade offerBox">
                    ...
                    <p class="categorystyle"><?php echo e($offer->category_name); ?></p>
                     <div class="offerType d-sm-flex justify-content-between my-4">
                        <div>
                           <p><strong>Offer</strong></p>
                           <p><?php echo e($offer->offer_name); ?></p>
                           <p><strong>Date of activation</strong></p>
                           <p><?php echo e(date('j \\ F Y', strtotime($offer->activation))); ?></p>
                        </div>
                        <div>
                           <p><strong>Offer Type</strong></p>
                             
                              <p><?php echo e($offer->offer_typeselected); ?></p>
                              
                           <p><strong>Date of deactivation</strong></p>
                           <p><?php echo e(date('j \\ F Y', strtotime($offer->deactivation))); ?></p>
                        </div>
                     </div>
                     <h6>Offer Message</h6>
                     <p><?php echo e($offer->offer_message); ?></p>
                     
                     <div class="text-center mt-4">
                        <a href="javascript:void(0)" class="editoffer" 
                     
                        onclick="editoffer1('<?php echo e($offer->id); ?>','<?php echo e($offer->user_id); ?>','<?php echo e($offer->name); ?>','<?php echo e($offer->category_id); ?>','<?php echo e($offer->offer_name); ?>','<?php echo e($offer->offer_type); ?>','<?php echo e($offer->activation); ?>','<?php echo e($offer->deactivation); ?>','<?php echo e($offer->offer_message); ?>')"
                        data-id="<?php echo e($offer->id); ?>" 
                        data-user_id="<?php echo e($offer->user_id); ?>"
                        data-name="<?php echo e($offer->name); ?>"
                        data-category_id="<?php echo e($offer->category_id); ?>"
                        data-offer_name="<?php echo e($offer->offer_name); ?>"
                        data-offer_type="<?php echo e($offer->offer_type); ?>"
                        data-activation="<?php echo e($offer->activation); ?>"
                        data-deactivation="<?php echo e($offer->deactivation); ?>"
                        data-offer_message="<?php echo e($offer->offer_message); ?>"
                        ><span class="icon-edit"></span></a>
                     <a href="javascript:void(0)" class="deleteoffer" 
                        data-id="<?php echo e($offer->id); ?>" ><span class="icon-delete"></span></a>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="row gy-5">
                        <div class="col-md-4 position-relative" >
                           ...
                           <select multiple="multiple" class="form-select js-example-basic-multiple" aria-label="Default select example" style="padding-bottom: 0;padding-top: 0;" name="category_id[]" id="category_id" >
                              ...
                              <?php $__currentLoopData = $business_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                           ...
                           <div class="col-md-4">
                              ...
                              <select class="form-select" aria-label="Default select example" name="offer_type" id="addoffer_type" style="padding-bottom: 0;padding-top: 0;">
                                 <option value="0" selected>Select Offer Type</option>
                                    <?php $__currentLoopData = $offerTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $offer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<script type="text/javascript">
   ...
   function editoffer1(id,user_id,name,category_id,offer_name,offer_type,activation,deactivation,offer_message){
     // alert(id+user_id+name+category_id+offer_name+offer_type+activation+deactivation);
      ...
      $(".addoffers").hide();
         ...
         var offer = <?php echo json_encode($offerTypes, 15, 512) ?>;
         ...
         var business_category = <?php echo json_encode($business_category, 15, 512) ?>;
            ...
            jQuery.ajax({
               ...
               success:function(data) { 
                  ...
                  jQuery('#deleteoffermsg').html("<div class='alert alert-success alert-dismissible text-white border-0 fade show' role='alert'><button type='button' class='btn-close btn-close-white' data-bs-dismiss='alert' aria-label='Close'></button><strong style='color:green'>"+obj.message+".</strong> </div>");
                     setTimeout(function(){
                           window.location.href = "<?php echo e(url('my-offers')); ?>";
                        }, 5000);
                  }
                  else if(obj.status==false){
   ...
   function send_notification_newOffer(last_offer_id)
   {
          ...
          jQuery.ajax({
         url: "<?php echo e(url('send_notification_newOffer')); ?>/"+last_offer_id,
         type: "get",
         cache: false,
...
<?php /**PATH C:\xampp\htdocs\development\wemarkthespot\resources\views/wemarkthespot/my-offers.blade.php ENDPATH**/ ?>