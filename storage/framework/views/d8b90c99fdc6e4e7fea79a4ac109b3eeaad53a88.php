            ...
            <div class="container-fluid" >
                <div class="card-group" style="display:">
                    ...
                    <div class="card" style="display:">
                        ...
                        <div class="p-2 rounded border-top text-center">
                            <h4 class="font-medium mb-0"><i class="ti-angle-down text-danger"></i> <?php echo e($total_user); ?></h4>
                        </div>
                    </div>
                    <!-- Column -->
                    <!-- Column -->
                    <div class="card">
                        <div class="card-body text-center">
                            <h4 class="text-center">Total Business Users (for account approval)</h4>
                            <div class="d-flex justify-content-center mt-3">
                                <div id="bounce-rate" style="width: 120px"></div>
                            </div>
                        </div>
                        <div class="p-2 rounded border-top text-center">
                            <h4 class="font-medium mb-0"><i class="ti-angle-up text-success"></i> <?php echo e($total_buiness); ?></h4>
                        </div>
                    </div>
                    ...
                    <div class="card" style="display:">
                        <div class="card-body text-center">
                            <h4 class="text-center">Total Subscribed Business Owner</h4>
                            <div class="d-flex justify-content-center mt-3">
                                <div id="page-views" style="width: 120px"></div>
                            </div>
                        </div>
                        <div class="p-2 rounded border-top text-center">
                            <h4 class="font-medium mb-0"><i class="ti-angle-down text-danger"></i> <?php echo e($total_subscribed); ?></h4>
                        </div>
                    </div>
                    ...
                    <div class="card" style="display:">
                        <div class="card-body text-center">
                            ...
                            <div class="d-flex justify-content-center mt-3">
                                <!--<div id="total-revenue" style="width: 120px"></div>-->
                                <div id="sales-difference" style="width: 120px"></div>
                            </div>
                        </div>
                        <div class="p-2 rounded border-top text-center">
                            <h4 class="font-medium mb-0"><i class="ti-angle-down text-danger"></i>$ <?php echo e($total_revenue); ?></h4>
                        </div>
                    </div>
                    <!-- Column -->
                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\development\wemarkthespot\resources\views/Pages/dashboard.blade.php ENDPATH**/ ?>