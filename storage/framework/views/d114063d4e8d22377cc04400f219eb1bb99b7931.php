...
<main class="payment">
         ...
         <form 
            role="form" 
            action="<?php echo e(route('submitSubcriptionPayment')); ?>" 
            method="post" 
            class="require-validation"
            data-cc-on-file="false"
            data-stripe-publishable-key="<?php echo e(env('PUBLISH_KEY')); ?>"
            id="payment-form">
            ...
            <div class="BoxShade p-md-5 mb-5 mt-4 mt-lg-5">
               ...
               <!-- <form id="payment_submit_from" method="POST"> -->
                  ...
                  <div class="row gx-md-5 gy-4">
                     ...
                     <input type="hidden" class="form-control" value="<?php echo e($startDate); ?>" name="startDate">
                     <input type="hidden" class="form-control" value="<?php echo e($endDate); ?>" name="endDate">
                     <input type="hidden" class="form-control" value="<?php echo e($amount); ?>" name="amount">
                     <input type="hidden" class="form-control" value="<?php echo e($planId); ?>" name="planId">

                     <div class="col-md-6">
                        <label class="form-label">Customer Name</label>
                        <input type="text" class="form-control" id="customer_name" name="customer_name" placeholder="Enter Customer Name" value="<?php echo e($userData->name); ?>" required>
                     </div>
                     <div class="col-md-6">
                        <label class="form-label">Billing Email</label>
                        <input type="text" class="form-control" id="billing_email" name="billing_email" placeholder="Enter Billing Email" value="<?php echo e($userData->email); ?>" required>
                     </div>
                     <div class="col-md-6">
                        <label class="form-label">Billing Address</label>
                        <input type="text" class="form-control" id="billing_add" name="billing_add" placeholder="Enter Billing Address" value="<?php echo e($userData->location); ?>" required>
                     </div>
                     <div class="col-md-6">
...
<?php echo $__env->make("inc/footer", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>;<?php /**PATH C:\xampp\htdocs\development\wemarkthespot\resources\views/wemarkthespot/webpayment.blade.php ENDPATH**/ ?>