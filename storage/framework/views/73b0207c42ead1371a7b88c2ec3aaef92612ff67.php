...
<?php echo $__env->make("inc/header", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>;
 ...
 <main>
            ...
            <div class="row">
               <div class="col-md-5 d-flex align-items-center">
                  <div>
                     ...
                     <div class="d-flex">
                        <a href="#" class="me-4"><img src="<?php echo e(asset('assets/images/andriod.png')); ?>"></a>
                        <a href="#"><img src="<?php echo e(asset('assets/images/ios.png')); ?>"></a>
                     </div>
                     
                  </div>
               </div>
               <div class="col-md-7 col-lg-6 offset-lg-1">
                  <figure><img src="<?php echo e(asset('assets/images/Location search-rafiki.png')); ?>"></figure>
               </div>
            </div>
            <div class="futcher text-center mt-60">
               ...
               <div class="row mt-4 gy-4">
                  <div class="col-md-6 col-lg-3">
                     <div class="fBox">
                        <img src="<?php echo e(asset('assets/images/chat.png')); ?>">
                        <h5>Chats</h5>
                  ...
                  <div class="col-md-6 col-lg-3">
                     <div class="fBox">
                        <img src="<?php echo e(asset('assets/images/purse.png')); ?>">
                        <h5>Free Sign up</h5>
                        <p>Lorem ipsum dolor sit amet, cotur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut lab.</p>
                     </div>
                  </div>
                  <div class="col-md-6 col-lg-3">
                     <div class="fBox">
                        <img src="<?php echo e(asset('assets/images/feedback.png')); ?>">
                        <h5>User Friendly</h5>
                        <p>Lorem ipsum dolor sit amet, cotur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut lab.</p>
                     </div>
                  </div>
         ...
         <section class="downLoad">
            <div class="container">
               <div class="row gy-4 justify-content-center">
                  <div class="col-md-4">
                     <figure><img src="<?php echo e(asset('assets/images/phone.png')); ?>"></figure>
                  </div>
            ...
            <div class="container-fluid">
               ...
               <div class="row gy-5">
                  <div class="col-xl-6 text-center">
                     <figure><img src="<?php echo e(asset('assets/images/Address-bro.jpg')); ?>"></figure>
                  </div>
                  <div class="col-xl-6">
                     <ul>
                        <li>
	...
	<?php echo $__env->make("inc/footer", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>;<?php /**PATH C:\xampp\htdocs\development\wemarkthespot\resources\views/wemarkthespot/webhome.blade.php ENDPATH**/ ?>