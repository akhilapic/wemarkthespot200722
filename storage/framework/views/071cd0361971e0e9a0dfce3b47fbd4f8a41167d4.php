...
<div class="page-wrapper">
    <div class="row page-titles">
        <div class="col-md-5 col-12 align-self-center">
            <h4 class="text-themecolor mb-0">Add New Promo Code</h4>
		</div>
		...
		<div class="col-12">
			<div class="card">
				<div class="border-bottom title-part-padding">
					<h4 class="card-title mb-0">Add Promo Code </h4>
				</div>
				<div class="card-body min_height">
					<form name="promocode_add" id="promocode_add" method="post" action="javascript:void(0)" enctype="multipart/form-data">
						<?php echo csrf_field(); ?>
					    <div class="row">
							<div class="">
								<!-- Alert Append Box -->
							...
							<div class="mb-3 col-md-6">
								...
								<input type="text" required id="amount" required name="amount" class="form-control">
							</div>
							...
							<input type="hidden" name="type" value="add">
								...
								<input type="date" required id="start_valid_date" required name="start_valid_date" class="form-control activationdate">
							</div>
									<div class="mb-3 col-md-6">
								<label for="date" class="control-label">End Valid Date: <span style="color:red">*</span></label>
								<input type="date" required id="end_valid_date" required name="end_valid_date" class="form-control activationdate">
							</div>
...
messages: {
	...
	submitHandler: function(form) {
	   var formData= new FormData(jQuery('#promocode_add')[0]);
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\development\wemarkthespot\resources\views/Pages/add_promocode.blade.php ENDPATH**/ ?>