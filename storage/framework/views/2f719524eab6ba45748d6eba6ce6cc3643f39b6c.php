                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="index.php">
                            ...
                            <b class="logo-icon">
                                ...
                                <!-- Dark Logo icon -->
                                <img src="<?php echo e(asset('assets/admin/images/logo-icon.png')); ?>" alt="homepage" class="dark-logo" />
                                <!-- Light Logo icon -->
                                <img style="width: 100%;" src="<?php echo e(asset('assets/images/logo_1.png')); ?>" alt="homepage" class="light-logo" />
                            </b>
                            <!--End Logo icon -->
                            <!-- Logo text -->
                            <span class="logo-text">
                                <!-- dark Logo text -->
                                <img src="<?php echo e(asset('assets/admin/images/logo-text.png')); ?>" alt="homepage" class="dark-logo" />
                                <!-- Light Logo text -->
                             <!--    <img src="<?php echo e(asset('assets/admin/images/logo-light-text.png')); ?>" class="light-logo" alt="homepage" /> -->
                            </span>
                        </a>
                        <!-- ============================================================== -->
                        <!-- End Logo -->
                                            ...
                                            <div id="carouselExampleControls" class="carousel slide carousel-dark" data-bs-ride="carousel">
                                                <div class="carousel-inner">
                                                    <div class="carousel-item active"><img class="d-block img-fluid"
                                                                src="<?php echo e(asset('assets/admin/images/big/img1.jpg')); ?>" alt="First slide">
                                                    </div>
                                                    <div class="carousel-item"><img class="d-block img-fluid"
                                                                src="<?php echo e(asset('assets/admin/images/big/img2.jpg')); ?>" alt="Second slide">
                                                    </div>
                                                    <div class="carousel-item"><img class="d-block img-fluid"
                                                                src="<?php echo e(asset('assets/admin/images/big/img3.jpg')); ?>" alt="Third slide">
                                                    </div>
                                                </div>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu mailbox dropdown-menu-end dropdown-menu-animate-up"
                                    ...
                                    <ul class="list-style-none">
                                        ...
                                        <img src="<?php echo e(\App\Models\User::where('id',Session::get('adminid'))->pluck('image')[0]); ?>" class="rounded-circle" />
                                         <img
                                                            src="<?php echo e(\App\Models\User::where('id',Session::get('adminid'))->pluck('image')[0]); ?>" alt="user"
...
<?php if(Session::has('image')): ?>
                                        <img src="<?php echo e(\App\Models\User::where('id',Session::get('adminid'))->pluck('image')[0]); ?>" class="rounded-circle" />
                                                                                                                    ...
                                                                                                                    <img
                                                            src="<?php echo e(Session::get('adminimage')); ?>" alt="user"
                                                            class="rounded-circle w-100">
<?php else: ?>
                                                        <img
                                                            src="<?php echo e(asset('assets/admin/images/users/2.jpg')); ?>" alt="user"
                                                            class="rounded-circle w-100">
<?php endif; ?>
 ...
 <span
                                                ...
                                                <a href="javascript:void(0)"
                                                    ...
                                                    <span class="user-img position-relative d-inline-block"> <img
                                                            src="<?php echo e(asset('assets/admin/images/users/3.jpg')); ?>" alt="user"
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle waves-effect waves-dark" href="#" data-bs-toggle="dropdown"
                            aria-haspopup="true" aria-expanded="false">
                                        ...
                                        <img src="<?php echo e(\App\Models\User::where('id',Session::get('adminid'))->pluck('image')[0]); ?>"  alt="user" width="30" class="profile-pic rounded-circle" />
<?php else: ?>
  <img src="<?php echo e(asset('assets/admin/images/users/1.jpg')); ?>" alt="user" width="30" class="profile-pic rounded-circle" />
<?php endif; ?>
...
<?php endif; ?>
                                   ...
                                   <!--  <img src="<?php echo e(asset('assets/admin/images/users/1.jpg')); ?>" alt="user" class="rounded-circle" width="60"> --></div>
                                <div class="ms-2">
                                    <h4 class="mb-0 text-white"><?php echo e(\App\Models\User::where('id',Session::get('adminid'))->pluck('name')[0]); ?></h4>
                                    <p class=" mb-0"><?php echo e(\App\Models\User::where('id',Session::get('adminid'))->pluck('email')[0]); ?></p>
                                </div>
                            </div>
                            ...
                            <a style="display:none" class="dropdown-item" href="<?php echo e(url('/change_password')); ?>">
                            ...
                            <!--</a>-->
                            <div class="dropdown-divider"></div>
                            <div class="pl-4 p-2"><a href="<?php echo e(url('signout')); ?>" class="btn d-block w-100 btn-info rounded-pill"> Logout</a></div>
                        </div>
                    </li>
                            <!-- ============================================================== -->
                            <!-- Language -->
            ...
            <!-- ============================================================== -->
            <!-- End Topbar header -->
            <!-- ============================================================== --><?php /**PATH C:\xampp\htdocs\development\wemarkthespot\resources\views/includes/header.blade.php ENDPATH**/ ?>