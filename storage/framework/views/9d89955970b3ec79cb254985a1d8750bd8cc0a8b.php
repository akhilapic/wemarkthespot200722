...
<head>
   ...
   <link rel="icon" href="<?php echo e(url('/assets/old/images/favicon.ico')); ?>" type="image/x-icon">
   ...
   <script src="<?php echo e(asset('assets/js/customvalidation.js')); ?>"></script>
...
<body>
   ...
   <header>
      <div class="container-fluid d-flex py-3">
         <a class="logo" href="<?php echo e(url('/')); ?>"><img src="<?php echo e('assets/images/logo.svg'); ?>"></a>
   ...
   <main class="mt-0">
         ...
         <div class="container-fluid">
            <div class="row gy-5">
               <div class="col-lg-6 d-none d-lg-block">
                  <img src="<?php echo e(asset('assets/images/Address-amico.png')); ?>">
               </div>
               <div class="col-lg-5 offset-lg-1">
                  <div class="login mt-2 mt-lg-0">
                     ...
                     <form action="<?php echo e(route('signupuser')); ?>" id="user_signup" method="post"
                        ...
                        <div class="thumb-up mb-5">
                           ...
                           <div class="p-image">
                              <button type="button" value="login" class="btn upload-button"><span
                                    class="icon-camera"></span></button>
                        ...
                        <div class="mb-3">
                           ...
                           <input type="text" class="form-control" id="name1"
                              onkeypress="return /^[a-zA-Z \s]+$/i.test(event.key)" name="name" value="<?php echo e(old('name')); ?>"
                              placeholder="Enter Business Owner Name">
                        </div>
                        <?php if($errors->has('name')): ?>
                        <span class="error alert alert-dange"><?php echo e($errors->first('name')); ?></span>
                        <?php endif; ?>
                        <span id="error_name"></span>
                        <div class="">
                           <label for="email" class="form-label">Email</label>
                           <input type="email" class="form-control" autocomplete="off" maxlength="50" name="email"
                              email="email" id="email" value="<?php echo e(old('email')); ?>" placeholder="Enter Email">
                        </div>
                        <label id="user_emailerror" style="color:red" class="errors"></label>
                        <span class="alert alert-dange" id="email_er"></span>
                        <?php if($errors->has('email')): ?>
                        <span class="error alert alert-dange"><?php echo e($errors->first('email')); ?></span>
                        <?php endif; ?>
                        <div class="mb-3">
                           <label for="phone-number" class="form-label d-block">Phone Number
                              <span>(Optional)</span></label>
                           <?php if($country_codedata): ?>
                           <div class="input-group">
                              <select id="country_code" name="country_code" class="form-select"
                                 style=" padding: 0px 15px;max-width: 200px;background-color: #f5f5f5;">
                        ...
                        <span class="error alert alert-dange"><?php echo e($errors->first('phone')); ?></span>
                        <?php endif; ?>
    ...
    display: -webkit-box;
    -webkit-line-clamp: 1;
    -webkit-box-orient: vertical;" name="location" value="<?php echo e(old('location')); ?>" id="location"
                        ...
                        <span class="error alert alert-dange"><?php echo e($errors->first('location')); ?></span>
                        <?php endif; ?>
                        <div class="mb-3 iconinput" style="position:relative;">
                           ...
                           <input type="password" id="password" class="form-control special_characters_type"
                              value="<?php echo e(old('password')); ?>" name="password" id="password1" placeholder="Enter Password">
                        ...
                        <span class="error alert alert-dange"><?php echo e($errors->first('password')); ?></span>
                        <?php endif; ?>
                        <div class="iconinput" style="position:relative;">
                           ...
                           <input type="password" class="form-control " required name="cpassword" id="cpassword"
                              value="<?php echo e(old('cpassword')); ?>" placeholder="Enter Confirm Password">
                           <span class="fa fa-eye-slash input_icon" id="eye2" style="cursor: pointer ;color: #9f9a9a;"
                              data-name="password"></span>
                        </div>
                        <?php if($errors->has('cpassword')): ?>
                        <span class="error alert alert-dange"><?php echo e($errors->first('cpassword')); ?></span>
                        <?php endif; ?>
                        ...
                        <span class="error alert alert-dange"><?php echo e($errors->first('business_type')); ?></span>
                        <?php endif; ?>

                        <div class="mb-3 d-flex">
                           <label for="businesType" class="form-label">Certificate of formation or Business Registration document (Docs, Pdf)<span
                                 style="color:red">*</span></label>
                           <input class="file_message ms-auto" id="filename" disabled />
                           <button type="button" style="border: 1px solid #c7c2c2; padding: 0px 18px;"
                              class="btn plusBTN upload_doc_ct" data-val="0"><span class="icon-plus"></span><input
                        ...
                        <div class="mb-2 form-check ps-0">
                           <?php if($errors->has('termsconditions')): ?>
                           <span class="error alert alert-dange"><?php echo e($errors->first('termsconditions')); ?></span>
                           <?php endif; ?>
                           <input type="checkbox" class="form-control" id="termsconditions" name="termsconditions" />

                           <label class="form-check-label" for="termsconditions">I accept <a href="#">Terms &
                                 Conditions</a> & <a href="#">Privacy Policy</a></label>
                        </div>
                        <?php if($errors->has('termsconditions')): ?>
                        <span class="error alert alert-dange" id="termsconditions"><?php echo e($errors->first('termsconditions')); ?></span>
                        <?php endif; ?>
                        <label class="errors" id="termsconditionserror" style="color:red"></label>
                        <!--   <?php if($errors->has('upload_doc')): ?>
                              <span class="error alert alert-dange"><?php echo e($errors->first('upload_doc')); ?></span>
                           <?php endif; ?> -->
                        <div class="w-75 mx-auto mt-5">
                           <input type="submit" class="btn btn-primary w-100 btn_submit_tranning" value="Sign Up"
                              data-bs-toggle="modal" data-bs-target="#approval">

                        </div>
                     </form>
                     <p class="allredy-account my-4 text-center">Already have an account? <a
                           href="<?php echo e(url('signin')); ?>">Sign In</a></p>
   ...
   <!-- Modal -->
   <div class="modal" id="approval" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
      aria-hidden="true">
   ...
   <!-- Scripts -->
   <script src="<?php echo e(url('/assets/old/js/jquery.min.js')); ?>"></script>
   <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.19.0/jquery.validate.min.js"></script>

   <!-- Bootstrap -->
   <script src="<?php echo e(url('/assets/old/js/popper.min.js')); ?>"></script>
   <script src="<?php echo e(url('/assets/old/js/bootstrap.min.js')); ?>"></script>

   <!-- Owl Carousel -->
   <script src="<?php echo e(url('/assets/old/js/owl.carousel.min.js')); ?>"></script>

   <!-- Select 2 Js -->
   <script src="<?php echo e(url('/assets/old/js/select2.min.js')); ?>"></script>

   <!-- Slick slider -->
   <script src="<?php echo e(url('/assets/old/js/slick.js')); ?>"></script>

   <!-- Custom Js -->
   <script src="<?php echo e(url('/assets/old/js/custom.js')); ?>"></script>
...
messaging.setBackgroundMessageHandler(function (payload) {
   ...
   // apiKey: "<?php echo e(env('apiKey')); ?>",
   //  authDomain: "<?php echo e(env('authDomain')); ?>",
   //  projectId: "<?php echo e(env('projectId')); ?>",
   //  storageBucket: "<?php echo e(env('storageBucket')); ?>",
   //  messagingSenderId: "<?php echo e(env('messagingSenderId')); ?>",
   //  appId: "<?php echo e(env('appId')); ?>" ,
   //  measurementId: "<?php echo e(env('measurementId')); ?>" 
...
</html><?php /**PATH C:\xampp\htdocs\development\wemarkthespot\resources\views/wemarkthespot/signup.blade.php ENDPATH**/ ?>