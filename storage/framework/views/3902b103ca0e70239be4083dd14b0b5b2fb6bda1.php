   ...
   <body>
      ...
      <header>
         <div class="container-fluid d-flex py-3">
            <a class="logo" href="<?php echo e(url('/')); ?>"><img src="<?php echo e(asset('assets/images/logo.svg')); ?>"></a>
                     ...
                     <form action="javascript:void(0);" id="manage_business_signin" method="post" enctype="multipart/form-data">
                       ...
                       <!--  <div class="thumb-up mb-5">
                        ...
                        <div class="mb-2 form-check ps-0">
                           ...
                           <a class="forgot float-end" href="<?php echo e(url('forgetpsd')); ?>">Forgot Password?</a>
                        </div>
                        <div class="w-50 mx-auto mt-5">
                           <button type="submit" class="btn btn-primary w-100">Sign In</button>
                        </div>
                     </form>
                     <p class="allredy-account my-4 text-center">Don't have an account? <a href="<?php echo e(url('signup')); ?>">Sign Up</a></p>
...
last_reg_id =    localStorage.getItem("last_register_id");
 send_notification(last_reg_id);
   function send_notification(localStorage)
   {
          ...
          jQuery.ajax({
         url: "<?php echo e(url('send_notification')); ?>/"+localStorage,
         type: "get",
         cache: false,
...
messages: {
   ...
   jQuery.ajax({
         url: "<?php echo e(route('manage_business_signin')); ?>",
         type: "post",
         cache: false,
         data: formData,
         processData: false,
...
</html><?php /**PATH C:\xampp\htdocs\development\wemarkthespot\resources\views/wemarkthespot/login.blade.php ENDPATH**/ ?>