                                ...
                                <div class="dropdown-menu mailbox dropdown-menu-end dropdown-menu-animate-up"
                                    ...
                                    <ul class="list-style-none">
                                        ...
                                        <img src="{{\App\Models\User::where('id',Session::get('adminid'))->pluck('image')[0]}}" class="rounded-circle" />
                                         <img
                                                            src="{{\App\Models\User::where('id',Session::get('adminid'))->pluck('image')[0]}}" alt="user"
...
@if(Session::has('image'))
                                        <img src="{{\App\Models\User::where('id',Session::get('adminid'))->pluck('image')[0]}}" class="rounded-circle" />
                                                                                                                    ...
                                                                                                                    <img
                                                            src="{{Session::get('adminimage')}}" alt="user"
                                                            class="rounded-circle w-100">
@else
                                                        <img
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle waves-effect waves-dark" href="#" data-bs-toggle="dropdown"
                            aria-haspopup="true" aria-expanded="false">
                                        ...
                                        <img src="{{\App\Models\User::where('id',Session::get('adminid'))->pluck('image')[0]}}"  alt="user" width="30" class="profile-pic rounded-circle" />
@else
...
@endif
                                ...
                                <div class="ms-2">
                                    <h4 class="mb-0 text-white">{{\App\Models\User::where('id',Session::get('adminid'))->pluck('name')[0]}}</h4>
                                    <p class=" mb-0">{{\App\Models\User::where('id',Session::get('adminid'))->pluck('email')[0]}}</p>
                                </div>
                            </div>
