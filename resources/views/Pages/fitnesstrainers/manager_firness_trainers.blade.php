                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <div class="col-md-12">
                                <!-- <a href="{{url('add_new_business_owner')}}" class="btn btn-success fa-pull-right btn-sm table_add_btn mx-2" data-bs-toggle="modal" data-bs-target="#add_workout_plan_modal" data-bs-whatever="@mdo">Add New Business Owner</a>
                                ...
                                <a href="{{url('add_new_business_owner')}}" class="btn btn-success fa-pull-right btn-sm table_add_btn mx-2" >Add New Business Owner</a>
                                <a style="display:none;" href="{{url('add_workout_plan')}}" class="btn btn-success fa-pull-right btn-sm table_add_btn mx-2"  data-bs-whatever="@mdo">Add Business owner account</a>
