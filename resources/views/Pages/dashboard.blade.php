            ...
            <div class="container-fluid" >
                <div class="card-group" style="display:">
                    ...
                    <div class="card" style="display:">
                        ...
                        <div class="p-2 rounded border-top text-center">
                            <h4 class="font-medium mb-0"><i class="ti-angle-down text-danger"></i> {{$total_subscribed}}</h4>
                        </div>
                    </div>
                    ...
                    <div class="card" style="display:">
                        ...
                        <div class="p-2 rounded border-top text-center">
                            <h4 class="font-medium mb-0"><i class="ti-angle-down text-danger"></i>$ {{$total_revenue}}</h4>
                        </div>
                    </div>
                    <!-- Column -->
                </div>
