...
label.error {
 ...
 <!--                  <span class="result" style="color:red"></span> -->
    ...
    -webkit-box-orient: vertical;" id="location" name="location" value="{{$account->location}}" placeholder="Enter Location">
                        ...
                        <div class="col-md-6">
                           <input type="hidden" value="{{$account->business_category}}," id="selcheckboxcategory"/>
                           <div><label class="form-label">Select Business Category <span style="color:Red">*</span>      <span id="select_buiness_categoryerror" style="color:red">Please select business category </span></label></div>
                              ...
                              @if(in_array($list->id,$selectbusiness_categoryArray))
                              <div class="form-check form-check-inline">
                                 <input checked class="form-check-input select_buiness_category" date-id= "{{$list->id}}" type="checkbox" name="business_category[]"  value="{{$list->id}}"id="{{$list->id}}">
                                 <label class="form-check-label" for="{{$list->id}}">{{$list->name}}</label>
                              </div>
                              @else
                                 <div class="form-check form-check-inline">
                                 <input class="form-check-input select_buiness_category" id="{{$list->id}}" date-id= "{{$list->id}}" type="checkbox" name="business_category[]"  value="{{$list->id}}">
                                 <label class="form-check-label" for="{{$list->id}}">{{$list->name}}</label>
                              </div>
                              @endif
                              @endforeach
                       ...
                       <!--  <img src="{{$account->upload_doc}}" style="width: 100px;height: 50px;"> -->
                        ...
                        <input type="hidden" id="hiddenbusiness_category" value="{{$account->business_category}}"/>
