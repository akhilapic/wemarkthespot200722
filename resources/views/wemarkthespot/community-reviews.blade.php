            ...
            for(i=0;i<app.length;i++)
            {
                  ...
                  if(app[i].user_image)
                  {
                    html+='<figure><img  id="imgsrc'+i+'" class="imgsrcClass" src="'+app[i].user_image+'" ></figure>';
                     ...
                     html+='<figure><img id="imgsrc'+i+'" class="imgsrcClass" src="{{asset('assets/images/img-3.png')}}"></figure>';
                  }
   ...
   <div class="container-fluid">
      ...
      <div class="row gy-4">
        ...
        ?>
         ...
         @foreach ($BusinessReviews as $i=> $user)
            ...
            <div class="BoxShade commutyReview">
                  ...
                  <div class="user-Detail">
                     ...
                     <ul class="share-up">
                        ...
                        @else
                        <li><a href="<?php echo $url;?>" data-business_id="{{$user->id}}" data-review_id="{{$user->id}}">Report</a></li>
                        @endif
                        <li class="clklikedislike" onclick="return likedislike('{{$user->id}}','{{$user->business_id}}','1')"  data-businessreview_id='{{$user->id}}' data-business_id='{{$user->business_id}}' data-like="1"><span class="icon-thumbs-up "  data-businessreview_id='{{$user->id}}' data-business_id='{{$user->business_id}}' data-llike="1"></span> @if($user->total_like)  {{$user->total_like}} @else 0 @endif </li>

                        <li class="clklikedislike" onclick="return likedislike('{{$user->id}}','{{$user->business_id}}','2')"  data-businessreview_id='{{$user->id}}' data-business_id='{{$user->business_id}}' data-like="2"><span class="icon-thumbs-down "  data-businessreview_id='{{$user->id}}' data-business_id='{{$user->business_id}}' data-llike="1"></span> @if($user->total_dislike)  {{$user->total_dislike}} @else 0 @endif</li>
                     </ul>
                     ...
                     <p class="Viewrepla" data-bs-toggle="collapse" href="#reviewshow{{$i}}" role="button" aria-expanded="false" aria-controls="reviewshow{{$i}}" style="display: inline-block;">&nbsp; </p><a href="#" class="reply btnreply" data-review_id ="{{$user->id}}" data-type="REVIEW" data-reply_id ="0">Reply</a>
                                    ...
                                    <div class="review-detail">
                                       ...
                                       <?php
                                        ...
                                        if(count($repliesArray)==$count)
                                        {
                                          ...
                                          <p data-bs-toggle="collapse" style="display:inline-block;" class="replys " href="#reviewshow{{$r}}" role="button" aria-expanded="false" aria-controls="reviewshow{{$r}}"><img src="{{asset('assets/images/reply.png')}}" width="15px"> <?php count($repliesArray[$r]['children']) ?> Reply</p>
                                          <a href="#"  class="reply btnreply ms-2" data-review_id ="{{$user->id}}" data-type="REVIEW" data-reply_id ="{{$repliesArray[$r]['id']}}">Reply</a>
                                          </div>
<?php
                                        }
                                        else
                                        {
                                           ?>
                                           <p><div class="d-block"><a href="#"  class="reply btnreply ms-2" data-review_id ="{{$user->id}}" data-type="REVIEW" data-reply_id ="{{$repliesArray[$r]['id']}}">Reply</a></div></p>
                                           <?php
                                        }
                                         //end level 1
                                          ...
                                          // echo count($level1);  //test  OK //RR
                                             if(count($level1)>0)
                                             {
                                                ...
                                                for($l1=0;$l1<count($level1);$l1++)
                                                {
                                                   ...
                                                   ?>
                                                   <div class="collapse subthreads" id="reviewshow{{$r}}" style="display:block;">  <!-- id ka issue hai pehle {{$r}} tha -->
                                                      <div class="Allreply">
                                                         <?php
                                                            ...
                                                            {
                                                               ?>
                                                               <figure><img src="{{$level1[$l1]['user']['image']}}"></figure>
                                                               <?php
                                                            }
                                                            else
                                                            {
                                                               ?>
                                                               <figure><img src="{{asset('/images/userimage.png')}}"></figure>
                                                               <?php
                                                            }
                                                         ?>
                                                         <div class="review-detail">
                                                            ...
                                                            <h6>{{$level1[$l1]['user']['name']}} </h6>
                                                            <p>{{$level1[$l1]['message']}}</p>
                                                         ...
                                                         <?php
                                                            ...
                                                            if(count($level1) > 0)
                                                            {
                                                               ...
                                                               <p data-bs-toggle="collapse" style="display:inline-block;" class="replys" href="#reviewshow0{{$r}}" role="button" aria-expanded="false" aria-controls="reviewshow0{{$r}}"><img src="{{asset('assets/images/reply.png')}}" width="15px"> {{count($level1[$l1]['children'])}} Reply </p>
                                                               <a href="#"  class="reply btnreply ms-2" data-review_id ="{{$user->id}}" data-type="REVIEW" data-reply_id ="{{$level1[$l1]['id']}}">Reply</a>
                                                               <?php
                                                               ...
                                                               if(count($level2)>0)
                                                               {
                                                                  ...
                                                                  {
                                                                     ?>
                                                                     <div class="collapse" id="reviewshow0'{{$r}}" style="display:block;">    <!-- Change id from {{$r}} to {{$l2}} -->
                                                                        <div class="Allreply">
                                                                           <?php
                                                                           $level3 = $level2[$l2]['children'];
                                                                           if($level2[$l2]['user']['image'])
                                                                     ...
                                                                     for($img2 =0; $img2<count($imageArray2);$img2++)
                                                                     {
                                                                        ...
                                                                        if(!empty($path_parts2['extension']))
                                                                        {
                                                                           ...
                                                                           if($extension2=="png" || $extension2=="jpg" || $extension2=="jpeg" || $extension2=="gif" || $extension2=="svg")
                                                                           {
                                                                              ...
                                                                              {
                                                                                 ?>
                                                                                 <figure class="comment_img"><img alt="1" src="{{$imageArray2[$img2]}}"></figure>  
                                                                              <?php
                                                                              }
                                                                           }
                                                                        }
                                                            ...
                                                            ?>
                                                                            ...
                                                                            {
                                                                              ?>
                                                                              <p data-bs-toggle="collapse" style="display:inline-block;" class="replys" href="#reviewshow1{{$r}}" role="button" aria-expanded="false" aria-controls="reviewshow1{{$r}}"><img src="{{asset('assets/images/reply.png')}}" width="15px"> {{count($level2[$l2]['children'])}}&nbsp;Reply </p>
                                                                              <a href="#"  class="reply btnreply ms-2" data-review_id ="{{$user->id}}" data-type="REVIEW" data-reply_id ="{{$level2[$l2]['id']}}">Reply</a>
                                                                              <?php
                                                                            }
                                                                            else
                                                                            {
                                                                           ...
                                                                           //level 3 start
                                                                              if(count($level3)>0)
                                                                              {
                                                                                 ...
                                                                                 for($cl3 = 0 ; $cl3< count($level3);$cl3++)
                                                                                 {
                                                                                    ...
                                                                                    ?>
                                                                                    <div class="collapse" id="reviewshow1{{$r}}" style="display:block;">  <!-- Change id from {{$r}} to {{$cl3}} -->
                                                                                       <div class="Allreply">
                                                                                          <?php
                                                                                            ...
                                                                                            $level4 = $level3[$cl3]['children']; //Added New for level 4
                                                                                             ...
                                                                                             {
                                                                                                ?>
                                                                                                <figure><img src="{{$level3[$cl3]['user']['image']}}"></figure>
                                                                                                <?php
                                                                                             }
                                                                                             else
                                                                                             {
                                                                                          ...
                                                                                          ?>
                                                                                          <div class="review-detail">
                                                                                             <h6>{{$level3[$cl3]['user']['name']}}</h6>
                                                                                             <p>{{$level3[$cl3]['message']}}</p>
                                                                                             <?php
                                                            ...
                                                            ?>
                                                                                             <!--<a href="#" class="reply btnreply" data-review_id ="{{$user->id}}" data-type="REVIEW" data-reply_id ="{{$level3[$cl3]['id']}}">Reply</a>-->
                                                                                          </div>
                                                                                       </div>
                                                                                    </div>
                                                                                    <?php
                                                                                    ...
                                                                                    <div class="collapse" id="reviewshow1{{$r}}" style="display:block;">  <!-- Change id from {{$r}} to {{$cl3}} -->
                                                                                       <div class="Allreply">
                                                                                          <?php
                                                                                             ...
                                                                                             {
                                                                                                ?>
                                                                                                <figure><img src="{{$level4[$cl4]['user']['image']}}"></figure>
                                                                                                <?php
                                                                                             }
                                                                                             else
                                                                                             {
                                                                                          ...
                                                                                          ?>
                                                                                          <div class="review-detail">
                                                                                             <h6>{{$level4[$cl4]['user']['name']}}</h6>
                                                                                             <p>{{$level4[$cl4]['message']}}</p>
                                                                                             <?php
                                                                     ...
                                                                     for($img4 =0; $img4<count($imageArray4);$img4++)
                                                                     {
                                                                        ...
                                                                        if(!empty($path_parts3['extension']))
                                                                        {
                                                                           ...
                                                                           if($extension3=="png" || $extension3=="jpg" || $extension3=="jpeg" || $extension3=="gif" || $extension3=="svg")
                                                                           {
                                                                              ...
                                                                              {
                                                                                 ?>
                                                                                 <figure class="comment_img"><img alt="1" src="{{$imageArray4[$img4]}}"></figure>  
                                                                              <?php
                                                                              }
                                                                           }
                                                                        }
                                                            ...
                                                            ?>
                                                                                             <!--<a href="#" class="reply btnreply" data-review_id ="{{$user->id}}" data-type="REVIEW" data-reply_id ="{{$level4[$cl4]['id']}}">Reply</a>-->
                                                                                          </div>
                                                                                       </div>
                                                                                    </div>
                                                                                    <?php
                                                            ...
                                                            {
                                                               ?>
                                                               <a href="#" class="reply btnreply" data-review_id ="{{$user->id}}" data-type="REVIEW" data-reply_id ="{{$level1[$l1]['id']}}">Reply</a>
                                                               <?php
                                                            }
                                                            ?> 
                                                      </div>
