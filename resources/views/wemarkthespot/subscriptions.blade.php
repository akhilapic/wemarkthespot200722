...
<style>
   ...
   <main class="subscription">
    ...
    {{Session::has('subscriptionsmsgerror')}}  
@if(Session::has('subscriptionsmsg'))
<div class="alert alert-success" id="subscriptionsmsg">
  {{ Session::get('subscriptionsmsg')}}
</div>
@endif
@if(Session::has('subscriptionsmsgerror'))
<div class="alert alert-success" id="subscriptionsmsgerror">
  {{ Session::get('subscriptionsmsgerror')}}
</div>
                    ...
                    <table class="table table-borderless">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td>{{date('d M Y', strtotime($current['startDate']))}}</td>
                           </tr>
                           <tr>
                              <th scope="row">Date of Expiration</th>
                              <td>{{date('d M Y', strtotime($current['endDate']))}}</td>
                           </tr>
                           <tr>
